...
<body>
    <div class="register-wrapper">
        <div class="register-container">
            ...
            <div class="register-form-container">
                ...
                <form method="POST" action="{{ route('register.post') }}" id="register-form">
                    ...
                    <div class="role-selection">
                        <div class="role-cards">
                            <!-- Donatur Role Card -->
                            <div class="role-card" onclick="selectRole('donatur')">
                                <div class="role-icon">
                            ...
                            <!-- Penerima Role Card -->
                            <div class="role-card" onclick="selectRole('penerima')">
                                <div class="role-icon">
                ...
                <!-- Social Media Registration Links -->
    ...
    <script>
        ...
        function selectRole(role) {
            ...
            const selectedRole = role === 'donatur' ? 'donatur' : 'penerima'; // Match the role values with the database
        ...
        function selectRole(role) {
            ...
            const selectedRole = role === 'donatur' ? 'donator' : 'penenrima'; // Match the role values with the database
            document.getElementById('role-input').value = selectedRole;
